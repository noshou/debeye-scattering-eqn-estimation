...
!
  ...
  do
    ...
    if ( s_eqi ( string(1:6), 'ENDMDL' )  ) then
      ...
      ! ignore all columns except 31-54 (x,y,z coords) and 77-80 (element + charge)
      read ( string, &
        '(6x,5x,1x,4x,1x,3x,1x,1x,4x,1x,3x,3f8.3,12x,6x,4x,a2,a2)', &
        iostat = ios ) x, y, z, element, charge

      if ( ios /= 0 ) then
        exit
      end if

      write ( xyz_file_unit, '(a2, a2, 2x,g14.6,2x,g14.6,2x,g14.6)' ) element, charge, x, y, z
